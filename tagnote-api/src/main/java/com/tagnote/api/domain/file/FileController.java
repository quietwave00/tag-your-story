package com.tagnote.api.domain.file;

import com.tagnote.api.domain.file.dto.request.DeleteFileRequest;
import com.tagnote.api.domain.file.dto.request.UploadFileRequest;
import com.tagnote.api.domain.file.dto.response.FileResponse;
import com.tagnote.api.domain.file.dto.response.MainFileResponse;
import com.tagnote.api.domain.file.dto.response.UploadFileResponse;
import com.tagnote.core.domain.file.service.File;
import com.tagnote.core.domain.file.service.FileFacade;
...
public class FileController {
    ...
    /*
     * 파일을 삭제한다.
     * 상태값만 변경 후, 추후에 배치 작업으로 파일 스토리지와 테이블에서 일괄 삭제 처리된다.
     */
    @DeleteMapping
