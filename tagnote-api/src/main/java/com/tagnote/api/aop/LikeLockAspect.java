package com.tagnote.api.aop;

import com.tagnote.api.domain.like.dto.request.LikeBoardRequest;
import com.tagnote.core.domain.board.service.Board;
import com.tagnote.core.domain.like.dto.command.LikeBoardCommand;
import com.tagnote.core.domain.like.service.Like;
...
public class LikeLockAspect {
     ...
     */
    @Before(value = "execution(* com.tagnote.api.domain.like.LikeController.like(..)) && args(likeBoardRequest, userId)"
     ...
     */
    @After(value = "execution(* com.tagnote.core.domain.like.service.LikeService.like(..)) && args(board, user)"
            , argNames = "board,user")
