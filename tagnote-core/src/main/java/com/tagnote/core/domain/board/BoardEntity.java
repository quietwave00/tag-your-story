...
public class BoardEntity extends BaseTime {
    ...
    private List<BoardUserTagEntity> boardUserTagEntityList = new ArrayList<>();
    ...
    public void addBoardUserTagList(List<BoardUserTagEntity> boardUserTagEntityList) {
        this.boardUserTagEntityList = boardUserTagEntityList;
        boardUserTagEntityList.forEach(entity -> entity.addBoard(this));
    }
    ...
    public BoardEntity update(String content, List<BoardUserTagEntity> boardUserTagEntityList) {
        this.content = content;
        this.boardUserTagEntityList = boardUserTagEntityList;
        return this;
    }
    ...
    public Board toBoard() {
        return Board.builder()
                ...
                .boardUserTagList(
                        Optional.ofNullable(this.getBoardUserTagEntityList())
