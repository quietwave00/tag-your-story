package com.tagnote.core.domain.comment.repository;

import com.tagnote.core.domain.comment.CommentEntity;
import com.tagnote.core.domain.comment.CommentStatus;
...
public interface CommentRepository extends JpaRepository<CommentEntity, Long> {
    ...
    Page<CommentEntity> findByParentAndStatus(com.tagnote.core.domain.comment.CommentEntity entity, CommentStatus commentStatus, PageRequest of);
}
